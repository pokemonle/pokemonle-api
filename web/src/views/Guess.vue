<template>
  <el-container>
    <el-header>
      ...
      <Setting :visible.sync="settingVisble" :gen.sync="gen" />
...
import { Setting, Intro, About } from "@/components/";
    ...
    async Guess() {
      ...
      try {
        ...
        if (data == "guess name error") {
          ...
          this.temp.imgUrl = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${String(
            id
          )}.png`;
